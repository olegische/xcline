...
const TaskHeader: React.FC<TaskHeaderProps> = ({
	...
	*/
	...
	const isCostAvailable = useMemo(() => {
		...
		return apiConfiguration?.apiProvider !== "ollama" && apiConfiguration?.apiProvider !== "lmstudio"
	}, [apiConfiguration?.apiProvider, apiConfiguration?.openAiModelInfo])

	const shouldShowPromptCacheInfo = doesModelSupportPromptCache && apiConfiguration?.apiProvider !== "xrouter"
