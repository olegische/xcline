...
const XRouterModelPicker: React.FC = () => {
	...
	useMount(() => {
		vscode.postMessage({ type: "refreshXRouterModels" })
	})
	...
	const modelIds = useMemo(() => {
		return Object.keys(xRouterModels).sort((a, b) => a.localeCompare(b))
	}, [xRouterModels])
			...
			<div>
				...
				<DropdownWrapper ref={dropdownRef}>
					<VSCodeTextField
						...
						style={{
							width: "100%",
							zIndex: XROUTER_MODEL_PICKER_Z_INDEX,
							position: "relative",
						}}>
						{searchTerm && (
							<div
...
export default XRouterModelPicker
...
export const XROUTER_MODEL_PICKER_Z_INDEX = 1_000
...
const DropdownList = styled.div`
	...
	z-index: ${XROUTER_MODEL_PICKER_Z_INDEX - 1};
